...
Signal.prototype.start = function(callback) {
  var self = this;
...
Signal.prototype.load = function(callback) {
  var self = this;
  var logs = [];
...
Signal.prototype.readLog = function(file, callback) {
  var self = this;
...
Signal.prototype.processLine = function(line, location, callback) {
  var self = this;
  line = line.trim();
  line = line.replace(/  /g, ' ');
  line = line.replace(/  /g, ' ');
...
Signal.prototype.buildStation = function(fields, location, callback) {
  var self = this;
...
Signal.prototype.buildNode = function(fields, location, callback) {
  var self = this;
...
Signal.prototype.isLocationFar = function(station, location) {
  var far = true;
...
Signal.prototype.insertLocation = function(obj, power, location) {
  /*
