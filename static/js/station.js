...
Station.prototype.draw = function() {
  ...
  google.maps.event.addListener(this.stationMarker, 'mouseover', function() {
    ...
    var infowindow = new google.maps.InfoWindow({
      content: '<b>ID:</b> ' + this.station.id + '</br><b>Name:</b> ' + this.station.name + '</br><b>Firstseen:</b> ' + this.station.firstseen + '</br><b>Lastseen:</b> ' + this.station.lastseen + '</br><b>Power:</b> ' + this.station.power + '</br><b>Devices NA:</b> ' + this.station.nodes.length + '</br><b>Devices A:</b> ' + this.station.clients.length
    });
